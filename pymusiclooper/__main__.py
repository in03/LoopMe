...
def ui():
    with gr.Blocks() as demo:
        ...
        gr.Markdown(
            """
            # LoopMe. ♾️
            **Easily create infinite music loops!**
            """
        )
        ...
        #         > 2. Click "Go".
        #         > 3. Download the looped files 
                
        #         ---
                
        #         LoopMe will turn your file into three files, an intro, loop and outro. It tries to find the longest repeated section of music.
        #         Simply repeat the "loop" file as many times as needed between the intro and outro segments.
        #         If some kind of clean musical repetition does not exist in your file, 
        #         LoopMe will go with its best guess, but don't expect great results. 
        #         """
        #     )
            
        with gr.Tab("Upload"):
            files = gr.inputs.File("multiple", type="file", label="Select Audio Files")
            audio_button = gr.Button("Slice & Dice")
